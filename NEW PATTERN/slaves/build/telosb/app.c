...
typedef TMilli slaveMoteC__clock__precision_tag;
...
static void slaveMoteC__AMControl__startDone(error_t error);
#line 138
static void slaveMoteC__AMControl__stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void slaveMoteC__Boot__booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void slaveMoteC__AMSend__sendDone(
#line 103
message_t * msg, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void slaveMoteC__clock__fired(void );
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t slaveMoteC__AMControl__start(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t slaveMoteC__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
slaveMoteC__Packet__getPayload(
#line 121
message_t * msg, 
...
static void slaveMoteC__Leds__set(uint8_t val);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void slaveMoteC__clock__startPeriodic(uint32_t dt);
# 29 "slaveMoteC.nc"
uint16_t slaveMoteC__msec = 0;
uint16_t slaveMoteC__sec = 0;
uint16_t slaveMoteC__min = 0;
uint16_t slaveMoteC__hr = 0;

uint8_t slaveMoteC__my_master = 0;
uint8_t slaveMoteC__level = -1;
uint8_t slaveMoteC__loopcnt = 0;
#line 36
uint8_t slaveMoteC__loopcntrw = 0;
uint16_t slaveMoteC__mote_locs[4][5];

uint16_t slaveMoteC__index = 1;
uint8_t slaveMoteC__synccheck = 0;

bool slaveMoteC__busy = FALSE;
bool slaveMoteC__data = FALSE;

message_t slaveMoteC__tsync_pkt;


static inline void slaveMoteC__Boot__booted(void );
...
static inline void slaveMoteC__clock__fired(void );
#line 129
static inline void slaveMoteC__AMControl__startDone(error_t err);




static inline void slaveMoteC__AMSend__sendDone(message_t *msg, error_t err);
...
static inline void slaveMoteC__AMControl__stopDone(error_t err);

static inline message_t *slaveMoteC__Receive__receive(message_t *msg, void *payload, uint8_t len);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static error_t /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40ca3cf8){
#line 65
  switch (arg_0x40ca3cf8) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40ca3cf8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40fa5220){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40fa5220) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40fa5220);
#line 120
      break;
#line 120
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x4133f148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x4133f148, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40fa5220){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40fa5220);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40fa5c70){
#line 39
  union __nesc_unnamed4276 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40fa5c70);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40ca3cf8){
#line 59
  switch (arg_0x40ca3cf8) {
#line 59
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40ca3cf8);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40ca5948){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40ca5948);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40fa5220){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40fa5220);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40ca5948){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40ca5948);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40fa5220){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40fa5220);
#line 88
      break;
#line 88
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4130b628){
#line 102
  switch (arg_0x4130b628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4130b628);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41340a98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41340a98, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x4133f148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x4133f148, msg);
#line 95
}
#line 95
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x41342088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x41342088, msg, payload, len);
#line 78
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t slaveMoteC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * slaveMoteC__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 134 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void slaveMoteC__Leds__set(uint8_t val){
#line 134
...
#line 150
      printf("Received\n");
      printfflush();
      if ((slaveMoteC__level == -1 || __nesc_ntoh_uint16(btrpkt->nodeid.nxdata) == slaveMoteC__my_master) || __nesc_ntoh_uint16(btrpkt->nodeid.nxdata) == 100) 
        {
          slaveMoteC__synccheck = 0;
          slaveMoteC__msec = __nesc_ntoh_uint16(btrpkt->msec.nxdata);
          slaveMoteC__sec = __nesc_ntoh_uint16(btrpkt->sec.nxdata);
          slaveMoteC__min = __nesc_ntoh_uint16(btrpkt->min.nxdata);
          slaveMoteC__hr = __nesc_ntoh_uint16(btrpkt->hr.nxdata);
          slaveMoteC__my_master = __nesc_ntoh_uint16(btrpkt->nodeid.nxdata);
          slaveMoteC__level = __nesc_ntoh_uint16(btrpkt->level.nxdata);
          slaveMoteC__index = __nesc_ntoh_uint16(btrpkt->index.nxdata);
          slaveMoteC__level++;
          slaveMoteC__Leds__set(slaveMoteC__level);
          printf("\ntime on %d  is %d:%d:%d:%d\nreceived level as value as %d\n", TOS_NODE_ID, slaveMoteC__hr, slaveMoteC__min, slaveMoteC__sec, slaveMoteC__msec, __nesc_ntoh_uint16(btrpkt->level.nxdata));
          printfflush();
          if (!slaveMoteC__busy) 
            {
              timesync *btrpkt = (timesync *)slaveMoteC__Packet__getPayload(&slaveMoteC__tsync_pkt, sizeof(timesync ));

#line 169
              __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
              __nesc_hton_uint16(btrpkt->msec.nxdata, slaveMoteC__msec);
              __nesc_hton_uint16(btrpkt->sec.nxdata, slaveMoteC__sec);
              __nesc_hton_uint16(btrpkt->min.nxdata, slaveMoteC__min);
              __nesc_hton_uint16(btrpkt->hr.nxdata, slaveMoteC__hr);
              __nesc_hton_uint16(btrpkt->level.nxdata, slaveMoteC__level);
              __nesc_hton_uint16(btrpkt->index.nxdata, slaveMoteC__index);
              if (slaveMoteC__AMSend__send(AM_BROADCAST_ADDR, &slaveMoteC__tsync_pkt, sizeof(timesync )) == SUCCESS) {
                slaveMoteC__busy = TRUE;
                }
            }
        }
    }
...
#line 187
      for (slaveMoteC__loopcnt = 0; slaveMoteC__loopcnt < 5; slaveMoteC__loopcnt++) 
        {
          if (__nesc_ntoh_uint8(btrpkt->loc_data[slaveMoteC__loopcnt].nxdata) != 0) 
            {
              slaveMoteC__mote_locs[0][slaveMoteC__loopcnt] = __nesc_ntoh_uint8(btrpkt->loc_data[slaveMoteC__loopcnt].nxdata);
              slaveMoteC__mote_locs[1][slaveMoteC__loopcnt] = __nesc_ntoh_uint8(btrpkt->loc_sec[slaveMoteC__loopcnt].nxdata);
              slaveMoteC__mote_locs[2][slaveMoteC__loopcnt] = __nesc_ntoh_uint8(btrpkt->loc_min[slaveMoteC__loopcnt].nxdata);
              slaveMoteC__mote_locs[3][slaveMoteC__loopcnt] = __nesc_ntoh_uint16(btrpkt->msec[slaveMoteC__loopcnt].nxdata);
            }
        }
...
#line 204
      slaveMoteC__mote_locs[0][__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) - 200] = TOS_NODE_ID - 100;
      slaveMoteC__mote_locs[1][__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) - 200] = slaveMoteC__min;
      slaveMoteC__mote_locs[2][__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) - 200] = slaveMoteC__sec;
      slaveMoteC__mote_locs[3][__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) - 200] = slaveMoteC__msec;
      slaveMoteC__data = TRUE;
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x413439d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x413439d0) {
#line 78
    case 5:
#line 78
      __nesc_result = slaveMoteC__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x413439d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40a2b730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40a2b730, addr, msg, len);
#line 80
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40b07088, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40b07088) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40b07088, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40b07088){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40b07088);
#line 15
      break;
#line 15
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
# 162 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40a2b730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40a2b730, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40fabe00){
#line 102
  switch (arg_0x40fabe00) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40fabe00);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40c8ce78){
#line 102
  switch (arg_0x40c8ce78) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40c8ce78);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40fa6a08, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40fa6a08) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40fa6a08, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40f36828, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40f36828) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40f36828, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x4133f148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x4133f148, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40f36828, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40f36828) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40f36828, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40f39db0){
#line 102
  switch (arg_0x40f39db0) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x40f39db0);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41343010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41343010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  slaveMoteC__AMControl__stopDone(error);
#line 138
}
#line 138
...
#line 113
  slaveMoteC__AMControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
static inline void slaveMoteC__AMSend__sendDone(message_t *msg, error_t err)
{
  if (&slaveMoteC__tsync_pkt == msg) 
    {
      slaveMoteC__busy = FALSE;
      slaveMoteC__Leds__set(slaveMoteC__level);
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  slaveMoteC__AMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x40a2ed30, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a2ed30) {
#line 100
    case 0U:
#line 100
      /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x40a2ed30, msg, error);
#line 100
      break;
#line 100
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x40ba0898){
#line 102
  switch (arg_0x40ba0898) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x40ba0898);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40c8ce78){
#line 102
  switch (arg_0x40c8ce78) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40c8ce78);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40ca3cf8){
#line 59
  switch (arg_0x40ca3cf8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40ca3cf8);
#line 59
      break;
#line 59
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x40bbf978){
#line 39
  union __nesc_unnamed4280 *__nesc_result;
#line 39

#line 39
  switch (arg_0x40bbf978) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x40bbf978);
#line 39
      break;
#line 39
    }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x40a2ed30, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a2ed30) {
#line 100
    case 0U:
...
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x40a2ed30, msg, error);
#line 100
      break;
#line 100
    }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40a5f010, message_t * msg, error_t error){
#line 110
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40a5f010, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40b08560, message_t * msg, error_t error){
#line 100
  switch (arg_0x40b08560) {
#line 100
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40b08560, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x40a5f9d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x40a5f9d0, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x40b0ce50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40b0ce50) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x40b0ce50, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40b07088, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40b07088, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40ca3cf8){
#line 65
  switch (arg_0x40ca3cf8) {
#line 65
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40ca3cf8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x40bc0e50){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40bc0e50) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x40bc0e50);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x40bc0e50){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x40bc0e50);
#line 128
      break;
#line 128
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40ca5948){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40ca5948);
#line 61
}
#line 61
# 93 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x40bc0e50){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x40bc0e50);
#line 97
      break;
#line 97
    }
...
static inline void slaveMoteC__clock__fired(void )
{
  if (slaveMoteC__msec < 1000) 
    {
      slaveMoteC__msec += 100;
    }
  else {
#line 62
    if (slaveMoteC__sec < 60) 
      {
        slaveMoteC__sec++;
        slaveMoteC__msec = 0;
        slaveMoteC__synccheck++;
        if (slaveMoteC__synccheck > 11) 
          {
            slaveMoteC__level = 0;
            slaveMoteC__my_master = 0;
            slaveMoteC__Leds__set(slaveMoteC__level);
          }
      }
    else {
#line 74
      if (slaveMoteC__min < 60) 
        {
          slaveMoteC__min++;
          slaveMoteC__sec = 0;
          slaveMoteC__msec = 0;
  ...
  if (slaveMoteC__index > 10) 
    {
      slaveMoteC__index = 1;
    }
  if (TOS_NODE_ID - 100 == slaveMoteC__index) 
    {
      if (!slaveMoteC__busy && slaveMoteC__data && slaveMoteC__my_master != 0) 
        {
          LocData *btrpkt = (LocData *)slaveMoteC__Packet__getPayload(&slaveMoteC__tsync_pkt, sizeof(LocData ));

#line 98
          __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
          for (slaveMoteC__loopcnt = 0; slaveMoteC__loopcnt < 5; slaveMoteC__loopcnt++) 
            {
              __nesc_hton_uint8(btrpkt->loc_data[slaveMoteC__loopcnt].nxdata, slaveMoteC__mote_locs[0][slaveMoteC__loopcnt]);
              __nesc_hton_uint8(btrpkt->loc_sec[slaveMoteC__loopcnt].nxdata, slaveMoteC__mote_locs[1][slaveMoteC__loopcnt]);
              __nesc_hton_uint8(btrpkt->loc_min[slaveMoteC__loopcnt].nxdata, slaveMoteC__mote_locs[2][slaveMoteC__loopcnt]);
              __nesc_hton_uint16(btrpkt->msec[slaveMoteC__loopcnt].nxdata, slaveMoteC__mote_locs[3][slaveMoteC__loopcnt]);
              printf("\nMote %d @%d:%d:%d\n", slaveMoteC__mote_locs[0][slaveMoteC__loopcnt], slaveMoteC__mote_locs[1][slaveMoteC__loopcnt], slaveMoteC__mote_locs[2][slaveMoteC__loopcnt], slaveMoteC__mote_locs[3][slaveMoteC__loopcnt]);
              printfflush();
            }
          printf("\Index is %d\n", slaveMoteC__index);
          printfflush();

          if (slaveMoteC__AMSend__send(slaveMoteC__my_master, &slaveMoteC__tsync_pkt, sizeof(LocData )) == SUCCESS) {
            slaveMoteC__busy = TRUE;
            }
#line 113
          slaveMoteC__data = FALSE;
          slaveMoteC__Leds__set(7);
          for (slaveMoteC__loopcntrw = 0; slaveMoteC__loopcntrw < 4; slaveMoteC__loopcntrw++) 
            {
              for (slaveMoteC__loopcnt = 0; slaveMoteC__loopcnt < 5; slaveMoteC__loopcnt++) 
                {
                  slaveMoteC__mote_locs[slaveMoteC__loopcntrw][slaveMoteC__loopcnt] = 0;
                }
            }
        }
    }
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void slaveMoteC__clock__startPeriodic(uint32_t dt){
#line 64
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t slaveMoteC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
static inline void slaveMoteC__Boot__booted(void )
{
  slaveMoteC__AMControl__start();
  slaveMoteC__clock__startPeriodic(100);
}
...
# 79 "/opt/tinyos-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x40bc1a60, uint8_t byte){
#line 79
  switch (arg_0x40bc1a60) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x40bc1a60, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x40bc1a60, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x40bc1a60) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x40bc1a60, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40c760c0, uint8_t data){
#line 54
  switch (arg_0x40c760c0) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40c760c0, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x40bc1a60, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x40bc1a60) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x40bc1a60, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40c760c0){
#line 49
  switch (arg_0x40c760c0) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40c760c0);
#line 49
      break;
#line 49
    }
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40c760c0, uint8_t data){
#line 54
  switch (arg_0x40c760c0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40c760c0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40c75088){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40c75088);
#line 39
}
#line 39
...
# 49 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40c760c0){
#line 49
  switch (arg_0x40c760c0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40c760c0);
#line 49
      break;
#line 49
    }
...
#line 55
{
  /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 5);
  return /*slaveMoteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
